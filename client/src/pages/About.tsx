...
const About = () => {
  ...
  return (
    <>
      ...
      <div className="py-16 bg-purple-700 text-center">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/contact">
              <Button className="border border-white text-white hover:bg-white hover:text-purple-700 py-3 px-6 rounded-md font-heading font-semibold transition-all h-auto">
                Contact Us
              </Button>
            </Link>
          </div>
