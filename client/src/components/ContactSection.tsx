        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-gray-600 my-4">
              Have questions about the program? Our team is here to help. Reach out using the form or contact us directly.
            </p>
            ...
            <div className="mt-8 space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Program Inquiries: <a href="mailto:info@dtl-hk.com" className="text-primary hover:underline">info@dtl-hk.com</a></p>
                  <p className="text-gray-600">Admissions: <a href="mailto:admissions@dtl-hk.com" className="text-primary hover:underline">admissions@dtl-hk.com</a></p>
                </div>
              </div>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          <SelectItem value="Application Question">Application Question</SelectItem>
